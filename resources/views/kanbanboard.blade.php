        ...
        <table class="w-full text-sm text-left text-gray-500">
            ...
            <tr>
                ...
                <th scope="col" class="px-6 py-3">
                    <button data-modal-target="NewCol" data-modal-toggle="NewCol" class="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm text-center h-[30px] w-[30px]" type="button">
                        +
                    </button>
                                            ...
                                            <form method="post" action="{{Route('FormRecords',[$resume->resume_id,$vacancy->vacancy_id])}}">
                                                ...
                                                <div class="flex flex-row border border-1 border-blue-600 p-2 mb-2 w-[210px]">
                                                    <div class="text-sky-900 flex flex-col">
                                                        ...
                                                        <a href="{{Route('thisResume',[$resume->resume_id])}}" class="mb-1 underline text-gray-400 hover:no-underline hover:text-sky-900">подробнее</a>
                                                        @if($col->id == 2)
                                                            <button type="button" data-modal-target="comment-{{$resume->resume_id}}" data-modal-toggle="comment-{{$resume->resume_id}}" class="flex hover:cursor-pointer text-white bg-blue-700 hover:bg-blue-800 rounded justify-center">Комментарий заказчика</button>
                                                            <div id="comment-{{$resume->resume_id}}" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] md:h-full">
                                                                <div class="relative w-full h-full max-w-2xl md:h-auto">
                                                                    <div class="relative bg-white rounded-lg shadow">
                                                                        <div class="flex items-start justify-between p-4 border-b rounded-t">
                                                                            ...
                                                                            <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center" data-modal-hide="comment-{{$resume->resume_id}}">
                                                                                <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                                                    ...
                                                    @if($col->id > 4)
                                                        <div class="flex flex-col justify-center ml-1">
                                                            <input type="submit" name="delete" value="Удалить" class="hover:cursor-pointer text-white bg-blue-700 hover:bg-blue-800 rounded mb-1">
                                                            <input type="submit" name="sent" value="Отправить" class="hover:cursor-pointer text-white bg-blue-700 hover:bg-blue-800 rounded px-1">
                                                        </div>
                                                    @endif
                                                </div>
                                            </form>
